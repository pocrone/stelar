    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="card py-4 px-4 col-md-12">
                <h4 class="card-title card-header text-center text-light d-flex justify-content-between align-items-center">
                    Koreksi Surat Keluar</h4>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.user_datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('leader_mail_correct', $group_id) }}",
                columns: [{
                        "data": null,
                        "searchable": false,
                        "orderable": false,
