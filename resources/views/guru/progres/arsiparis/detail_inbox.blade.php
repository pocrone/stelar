                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                            aria-controls="pills-home" aria-selected="true">Detail Surat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                            aria-controls="pills-profile" aria-selected="false">Disposisi Surat</a>
                    </li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive-sm">
                                                <table class="table table-bordered dispos_datatable" style="width: 100%;">
                                                    <thead>
                                                        <tr>
    ...
    <script>
        $(document).ready(function() {
            var table = $('.dispos_datatable').DataTable({
                ...
                "processing": true,
                "ajax": {
                    "url": "{{ route('disposition_archive', $data->id) }}",
                    "dataType": "json",
