...
class ArchivistInboxRetention extends Controller
{
    public function inbox_retention(Request $request)
    {
        ...
        return view('siswa.archivist.inbox_retention')->with('nama', auth()->user()->name);
    }
    public function outbox_retention(Request $request)
    {
        ...
        return view('siswa.archivist.outbox_retention')->with('nama', auth()->user()->name);;
    }
}
